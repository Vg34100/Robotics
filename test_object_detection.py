...
def navigate_to_waypoint_and_check(vehicle, waypoint):
    waypoint_location = LocationGlobalRelative(waypoint[0], waypoint[1], vehicle.location.global_relative_frame.alt)
...
if __name__ == '__main__':
    ...
    try:
        ...
        for waypoint in listofwaypoints:
            navigate_to_waypoint_and_check(vehicle, waypoint)
